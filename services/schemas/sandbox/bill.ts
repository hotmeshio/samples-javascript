...
export const schema: Types.WorkflowSearchSchema = {
    ...
    userId: { type: 'TAG', sortable: true, primitive: 'string', required: true, examples: ['user-jan.doe.1'] },
    planId: { type: 'TAG', sortable: true, primitive: 'string', required: true, examples: ['567887654567'] },
    plan: { type: 'TAG', sortable: true, primitive: 'string', required: true, examples: ['enterprise', 'pro'] },
